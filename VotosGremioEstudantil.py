...
print("Eleções do Gremio estudantio")
...
while total != 5:
    ...
    while True:
        try:
            turma = int(input("Digite o numero da sua turma para votar:\n"))
            if not 0 < turma < 4:
                raise ValueError("Digite um numero válido para a turma")
        except ValueError as error:
            print("Digite um numero válido para a turma")
        else:
            break
    if turma == 1:
        while vt != -1:
            ...
            while True:
                try:
                    vt = int(input(f"Numero do Candidato:\n"))
                    if not (-1 < vt < 7 or vt == 10) and vt is not int:
                        raise ValueError("Digite um numero válido para o Candidato")
                except ValueError as error:
                    print("Digite um numero válido para o Candidato")
                else:
                    break
            if vt == 0:
                nulo += 1
        ...
        print("Digite o numero da sua turma para iniciar a votação!!\n")
print()
